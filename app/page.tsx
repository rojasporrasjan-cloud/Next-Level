  ...
  return <>
    ...
    <main id="main">
      <section className="hero" aria-labelledby="hero-title">
        <figure className="hero-photo"><img src="/media/garage-inspiration.png" alt="Design inspiration: a modern garage with a graphite decorative flake floor and linear lighting" width="1672" height="941" fetchPriority="high" /><figcaption>DESIGN INSPIRATION · AI VISUALIZATION</figcaption></figure>
        <div className="hero-copy"><p className="eyebrow"><span className="orange-dot" /> CONCRETE. REIMAGINED.</p><h1 id="hero-title">A FLOOR<br />BEYOND<br /><em>ORDINARY.</em></h1><p className="intro">A new finish. A whole new feeling.<br />Concrete coatings for the spaces you call yours.</p><div className="hero-actions"><WhatsAppLink>Let’s talk floors</WhatsAppLink><a href="#work" className="hero-work-link">Explore our work <ArrowUpRight size={18} aria-hidden="true" /></a></div><div className="hero-location"><MapPin size={17} aria-hidden="true" /><span>Locally based in<br /><strong>Boiling Springs, South Carolina</strong></span></div></div>
        <a href="#work" className="hero-project"><img src="/media/flake-floor-12.jpg" width="576" height="1024" alt="Decorative flake finish from a real Next Level project" /><span><small>FROM OUR PROJECTS</small><strong>All in the details.</strong><span>Take a closer look <ArrowUpRight size={16} aria-hidden="true" /></span></span></a>
        <div className="hero-bottom"><span>YOUR SPACE. THE NEXT LEVEL.</span><a href="#services">DISCOVER MORE <span aria-hidden="true">↓</span></a></div>
      </section>
