  ...
  return <>
    ...
    <main id="main">
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-copy"><p className="eyebrow"><span className="orange-dot" /> BOILING SPRINGS, SOUTH CAROLINA</p><h1 id="hero-title">GOOD FLOORS.<br />GREAT SPACES.<br /><em>NEXT LEVEL.</em></h1><p className="intro">Turn everyday concrete into the best part of your space. Distinctive finishes for garages, interiors, and life outside.</p><div className="hero-actions"><WhatsAppLink>Let’s talk about your floor</WhatsAppLink><a href="#work" className="hero-work-link">See our work <ArrowUpRight size={18} aria-hidden="true" /></a></div><p className="micro">Your space. Your style. A conversation away.</p></div>
        <div className="hero-bottom"><span>CONCRETE COATINGS & MORE</span><a href="#services">SCROLL TO EXPLORE <span aria-hidden="true">↓</span></a></div>
      </section>
